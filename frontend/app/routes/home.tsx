          ...
          <div className="row align-items-center g-5">
            <div className="col-lg-6">
              ...
              <p className="lead text-muted mb-4">
                Productos nuevos, reacondicionados y usados con una interfaz lista para conectar con la API.
              </p>
              <p className="text-muted mb-4">Estado del prototipo: {loaderData.name}</p>
      ...
      <section className="py-5 bg-white">
        <div className="container">
          <div className="text-center mb-5">
            ...
            <p className="text-muted">Contenido de ejemplo para validar el diseño antes de conectar la API.</p>
          </div>
